# FASTAPI for status and to end HTTPExceptions
from sys import api_version
from fastapi import FastAPI, status, HTTPException

# Turn classes into JSONs and return
...
# General execution and the docker
app = FastAPI()
...
def produce_kafka_string(json_as_string):
    # Create a producer
    producer = KafkaProducer(bootstrap_servers='kafka:9092', acks=1, api_version=(0, 10, 1))
